...
public class HastaneSliderController : MonoBehaviour
{
    ...
    public HealController healController; // HealController referansı
    ...
    void Start()
    {
        // HealController'dan verileri çek
        yaraliSavasciSayisi = healController.woundedSoldier;
        yaraliOkcuSayisi = healController.woundedArcher;
        Debug.Log("Yaralı Savasci Sayisi : " + yaraliSavasciSayisi);
        Debug.Log("Yaralı Okcu Sayisi : " + yaraliOkcuSayisi);
