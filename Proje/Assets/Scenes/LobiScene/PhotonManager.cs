...
public class PhotonManager : MonoBehaviourPunCallbacks
{
    ...
    private IEnumerator AutoRefreshRoomList()
    {
     ...
     /// <summary>
    /// LocalPlayer üzerindeki tüm Photon custom properties'i gerçekten siler.
    /// </summary>
    private void ClearLocalPlayerCustomProperties()
    {
        ...
        Debug.Log("LocalPlayer custom properties silindi.");
    }
    ...
    private void CreateRoomInternal(string roomName)
    {
        if (string.IsNullOrEmpty(roomName))
        {
         ...
         ClearLocalPlayerCustomProperties();
            ...
            CustomRoomProperties = new ExitGames.Client.Photon.Hashtable
    {
        ...
        LogManager.Instance.LogEkle($"Oda oluşturma isteği gönderildi: {fullRoomName}");
    }
    ...
    public override void OnLeftRoom()
    {
        ...
        // Oda terk edildiyse doğrudan lobby’ye dön
    Debug.Log("Odadan çıkıldı, lobiye yeniden katılıyor…");
    PhotonNetwork.JoinLobby();
    }

    public override void OnJoinedLobby()
{
    Debug.Log("Lobiye başarıyla katıldık.");
    RefreshRoomList();
}
